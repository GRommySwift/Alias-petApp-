...
class GameScreenViewModel: ObservableObject {
    ...
    @Published var testArray = ["кот", "дом", "море", "солнце", "книга", "яблоко", "школа", "музыка", "компьютер", "футбол", "путешествие", "часы", "красный", "цветок", "дружба", "звезда", "счастье", "океан", "город", "карта"]
